...
<div class="container-fluid bg-light">
    <div class="row">
        ...
        <div class="col-10 p-4">
            ...
            ?>
            <h3 class="mt-5 pt-3 text-dark mb-4">Ventana de inicio - Usuario <?php echo "$idUsuario"; ?></h3>
            ...
            <p class="fs-5 lh-lg">
                <b>Contáctanos hoy mismo</b> y déjanos ayudarte a encontrar el lugar perfecto para llamar hogar. En Inmobiliaria X, estamos comprometidos con tu satisfacción y te brindaremos un servicio personalizado en cada paso del proceso.
            </p>
        </div>
        <div class="col-1 p-4">
        </div>
